% Variablen
R = (1000*3000 ./ 4000);         % Widerstand in Ohm
L = 4e-3;        % Induktivität in Henry
omega = logspace(0, 10, 100); % Logarithmische Frequenzen von 10^0 bis 10^10

% Berechnung
omega_G = R ./ L;  % Grenzfrequenz für Tiefpass
U = 1 ./ (1 + (omega*j ./ omega_G)); % Verstärkung U
...
title('Bode-Diagramm für ein RL-Element (Tiefpass)', 'FontSize', 16);
grid on;
